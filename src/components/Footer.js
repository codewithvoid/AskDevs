          ...
          <div class="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
            <div class="lg:w-1/3 md:w-1/2 w-full px-12">
              ...
              <nav class="list-none mb-10">
                <li>
                  <a
                    class="title-font font-medium text-white tracking-widest text-xlm mb-3"
            ...
            <div class="lg:w-1/3 md:w-1/2 w-full px-2">
              <h2 class="title-font font-large text-white tracking-widest text-xl mb-3">
                Contribute
              </h2>
              <nav class="list-none mb-10">
                <li>
            ...
            <div class="lg:w-1/4 md:w-1/6 w-full px-2">
              <nav class="list-none mb-1">
                ...
                <li>
                  <a class="title-font font-medium text-white tracking-widest text-sm mb-3">
